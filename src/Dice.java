...
class Dice {
	...
	public static void main(String[] args) throws Exception {
		input = new Scanner(new File(Dice.class.getName().toLowerCase() + ".dat"));
		Stream<String> inputStream = new BufferedReader(new FileReader(new File(Dice.class.getName().toLowerCase() + ".dat"))).lines();
		doIt();
	}
